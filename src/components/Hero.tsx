          ...
          <div className="animate-fade-in">
            <div className="relative mb-16 mt-32 sm:mt-34">
              <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[121px] font-bold mb-4 tracking-tight relative overflow-hidden py-2">
                <span className={`inline-block ${nameBaseClasses} ${isFirstLoad ? '-translate-x-10 bg-gradient-to-r from-white/0 via-white/0 to-white/0' : 'translate-x-0 bg-gradient-to-r from-white via-white to-white/80'}`}>
                  Ahmed
                </span>
                <span className={`block ${nameBaseClasses} ${isFirstLoad ? 'translate-x-10 bg-gradient-to-r from-white/0 via-white/0 to-primary-foreground/0' : 'translate-x-0 bg-gradient-to-r from-white/80 via-white to-primary-foreground'}`}>
                  Rehman
                </span>
              </h1>
            ...
            <div className="mb-8">
              <p className={`text-base sm:text-lg md:text-xl text-foreground/90 max-w-2xl mx-auto leading-relaxed mb-6 px-4 transition-all duration-700 ease-out ${isFirstLoad ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`} style={{ transitionDelay: '400ms' }}>
                  ...
                  return (
                    <span 
                      ...
                      className={`px-4 py-2 bg-accent/10 text-accent rounded-full text-sm font-medium
                                ...
                                ${isFirstLoad ? initialTransform : 'translate-x-0 translate-y-0 opacity-100'}`}
            ...
            <div className="relative mb-12">
              <p className={`text-base sm:text-lg mb-8 text-foreground/85 max-w-3xl mx-auto leading-relaxed px-4 transition-all duration-700 ease-out ${isFirstLoad ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`} style={{ transitionDelay: '1000ms' }}>
              ...
              <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center px-4 transition-all duration-700 ease-out ${isFirstLoad ? 'opacity-0 translate-y-4' : 'opacity-100 translate-y-0'}`} style={{ transitionDelay: '1100ms' }}>
                <Button 
                  size="default" 
